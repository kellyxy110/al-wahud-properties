        ...
        {[
          {
            ...
            desc: 'We match buyers with premium verified properties across Lagos, Abuja and Port Harcourt.',
          ...
          },
          {
            ...
            desc: 'Long-term and short-let arrangements. Tenant sourcing, referencing, lease agreements.',
          ...
          },
          {
            ...
            desc: 'NIESV-certified professional valuers. Full written report accepted by banks for mortgage.',
          ...
          },
          {
            ...
            desc: 'ROI analysis, yield projections, growth corridor identification for diaspora investors.',
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4,1fr)', gap: 20 }}>
          {[
            ...
            <div key={s.title} style={{ background: '#fff', borderRadius: 20, padding: '28px 22px', boxShadow: '0 4px 20px rgba(0,0,0,.07)', cursor: 'pointer', borderTop: `4px solid ${s.borderColor}`, transition: 'transform .3s, box-shadow .3s' }}>
              ...
              <div style={{ fontFamily: 'var(--font-poppins)', fontSize: 12, fontWeight: 700, color: s.linkColor }}>Learn More →</div>
            </div>
          ))}
        </div>
      </section>
