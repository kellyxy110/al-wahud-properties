...
export default function Navbar() {
  ...
  return (
    <>
      {/* ── DESKTOP NAV ── */}
      <nav
        className="hidden lg:flex items-center justify-between px-16 h-[70px] sticky top-0 z-[200]"
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          <div className="flex gap-3 items-center">
            ...
            <a href="https://www.instagram.com/alwajudproperties" target="_blank" rel="noopener" aria-label="Instagram"
              className="w-8 h-8 rounded-full flex items-center justify-center transition-colors hover:bg-[var(--primary)] hover:text-white"
              style={{ background: '#F3F4F6', color: 'var(--primary)' }}>
              <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2" y="2" width="20" height="20" rx="5"/><circle cx="12" cy="12" r="4"/><circle cx="17.5" cy="6.5" r="1.5" fill="currentColor"/></svg>
            </a>
            <a href="https://www.tiktok.com/@alwajudproperties" target="_blank" rel="noopener" aria-label="TikTok"
              className="w-8 h-8 rounded-full flex items-center justify-center transition-colors hover:bg-[var(--primary)] hover:text-white"
              style={{ background: '#F3F4F6', color: 'var(--primary)' }}>
      ...
      <header className="mob-header lg:hidden">
        <div style={{ display: 'flex', gap: '10px' }}>
          <a href="https://www.instagram.com/alwajudproperties" target="_blank" rel="noopener" aria-label="Instagram">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#1B9954" strokeWidth="2">
