...
export interface Property {
  ...
  desc: string;
  features: string[];
  propAmenities: { i: string; l: string }[];
  tiktok: string;
  wa: string;
  budget: string;
  agentName?: string;
...
export const FEATURED_PROPERTIES: Property[] = [
  {
    ...
    price: '₦120,000,000', period: '/yr',
    location: 'No. 9 Ikeja GRA, Lagos', locationKey: 'lagos',
    status: 'FOR RENT', statusColor: '#E63946', statusKey: 'rent',
    ptype: 'duplex', budget: 'mid',
    beds: 3, baths: 3, sqm: 250,
    img: 'https://images.unsplash.com/photo-1613977257363-707ba9348227?w=600&h=420&fit=crop',
    imgs: ['https://images.unsplash.com/photo-1613977257363-707ba9348227?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=900&h=600&fit=crop'],
    gradient: 'linear-gradient(135deg,#2D7A76,#0F5E36)',
    extraChips: ['🔒 24/7'],
    featured: true,
    desc: 'A beautifully maintained 3-bedroom detached house in the prestigious Ikeja GRA. Features spacious living areas, fitted kitchen, and a lush garden. Perfect for families seeking comfort and security in the heart of Lagos.',
    features: ['Fitted Kitchen','Boys Quarters','Spacious Garden','CCTV System','Tiled Compound','Ample Parking'],
    propAmenities: [{i:'🏊',l:'Pool'},{i:'🏋️',l:'Gym'},{i:'🔒',l:'Security'},{i:'🚗',l:'Parking'},{i:'⚡',l:'Generator'},{i:'💧',l:'Water'},{i:'🌿',l:'Garden'},{i:'📡',l:'Internet'}],
    tiktok: '7612758048372886802',
    wa: 'Hello!%20I%20am%20interested%20in%20the%20Classical%20Lagos%20House%20in%20Ikeja%20GRA.',
    agentName: 'Al-Wajud Team', agentInitials: 'AW',
    agentGradient: 'linear-gradient(135deg,#FFB703,#E63946)', agentRating: 5.0,
  },
  {
    id: 2,
    title: 'Luxury Penthouse',
    price: '₦350,000,000', period: '',
    location: 'Lekki Phase 1, Lagos State', locationKey: 'lagos',
    status: 'FOR SALE', statusColor: '#0F5E36', statusKey: 'sale',
    ptype: 'apartment', budget: 'high',
    beds: 5, baths: 5, sqm: 420,
    img: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=600&h=420&fit=crop',
    imgs: ['https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1616137466211-f939a420be84?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1600121848594-d8644e57abab?w=900&h=600&fit=crop'],
    gradient: 'linear-gradient(135deg,#FBC598,#E63946)',
    extraChips: ['🔒 24/7'],
    desc: "An iconic 5-bedroom penthouse on the 20th floor offering panoramic ocean views. State-of-the-art kitchen, private rooftop terrace, and world-class finishes. A true trophy asset in one of Lagos's most coveted addresses.",
    features: ['Rooftop Terrace','Ocean View','Smart Home','Private Elevator','Walk-in Closet','Home Theater'],
    propAmenities: [{i:'🏊',l:'Pool'},{i:'🏋️',l:'Gym'},{i:'🔒',l:'Security'},{i:'🚗',l:'Parking'},{i:'⚡',l:'Generator'},{i:'🛎',l:'Concierge'},{i:'🍽',l:'Restaurant'},{i:'🌊',l:'Ocean View'}],
    tiktok: '7612758048372886802',
    wa: 'Hello!%20I%20am%20interested%20in%20the%20Luxury%20Penthouse%20in%20Lekki%20Phase%201.',
    agentName: 'Al-Wajud Team', agentInitials: 'AW',
    agentGradient: 'linear-gradient(135deg,#1B9954,#0F5E36)', agentBorderColor: '#FFB703', agentRating: 5.0,
  },
  {
    id: 3,
    title: 'Modern Duplex',
    price: '₦85,000,000', period: '/yr',
    location: 'Victoria Island, Lagos', locationKey: 'lagos',
    status: 'FOR RENT', statusColor: '#E63946', statusKey: 'rent',
    ptype: 'duplex', budget: 'mid',
    beds: 4, baths: 4, sqm: 310,
    img: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=600&h=420&fit=crop',
    imgs: ['https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1554995207-c18c203602cb?w=900&h=600&fit=crop'],
    gradient: 'linear-gradient(135deg,#2D7A76,#FFB703)',
    extraChips: ['🔒 24/7'],
    desc: 'Stunning 4-bedroom contemporary duplex in a serene gated estate on Victoria Island. Italian tiles, designer fittings, and a fully equipped gym on-site. Walking distance to major banks and restaurants.',
    features: ['Italian Tiles','Modern Kitchen','Home Office','Solar Panels','CCTV','Intercom'],
    propAmenities: [{i:'🏋️',l:'Gym'},{i:'🔒',l:'Security'},{i:'🚗',l:'Parking'},{i:'⚡',l:'Generator'},{i:'💧',l:'Water'},{i:'📡',l:'Fibre Wi-Fi'},{i:'🌿',l:'Garden'},{i:'🏪',l:'Estate Shop'}],
    tiktok: '7612758048372886802',
    wa: 'Hello!%20I%20am%20interested%20in%20the%20Modern%20Duplex%20in%20Victoria%20Island.',
    agentName: 'Al-Wajud Team', agentInitials: 'AW',
    agentGradient: 'linear-gradient(135deg,#FFB703,#1B9954)', agentRating: 5.0,
  },
  {
    id: 4,
    title: 'Executive 4-Bedroom Bungalow',
    price: '₦180,000,000', period: '',
    location: 'Maitama District, Abuja FCT', locationKey: 'abuja',
    status: 'FOR SALE', statusColor: '#0F5E36', statusKey: 'sale',
    ptype: 'duplex', budget: 'high',
    beds: 4, baths: 4, sqm: 320,
    img: 'https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=600&h=420&fit=crop',
    imgs: ['https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=900&h=600&fit=crop'],
    gradient: 'linear-gradient(135deg,#0F5E36,#2D7A76)',
    extraChips: ['🔒 24/7'],
    desc: 'Prestigious 4-bedroom detached bungalow in the most exclusive district of Abuja. Manicured gardens, 3-car garage, and an integrated solar power system. C of O documentation available.',
    features: ['3-Car Garage','Solar Power','Boys Quarters','Landscaped Garden','Security Post','BQ'],
    propAmenities: [{i:'🔒',l:'Security'},{i:'🚗',l:'Garage'},{i:'⚡',l:'Solar'},{i:'💧',l:'Borehole'},{i:'🌿',l:'Garden'},{i:'🏞',l:'Quiet Area'},{i:'📡',l:'Internet'},{i:'🏠',l:'BQ'}],
    tiktok: '7612758048372886802',
    wa: 'Hello!%20I%20am%20interested%20in%20the%20Executive%20Bungalow%20in%20Maitama%20Abuja.',
    agentName: 'Al-Wajud Team', agentInitials: 'AW',
    agentGradient: 'linear-gradient(135deg,#FFB703,#E63946)', agentRating: 5.0,
  },
  {
    ...
    price: '₦45,000,000', period: '/yr',
    location: 'Lekki Phase 2, Lagos', locationKey: 'lagos',
    status: 'FOR RENT', statusColor: '#E63946', statusKey: 'rent',
    ptype: 'apartment', budget: 'low',
    beds: 2, baths: 2, sqm: 120,
    img: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&h=420&fit=crop',
    imgs: ['https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop'],
    gradient: 'linear-gradient(135deg,#FBC598,#FFB703)',
    extraChips: ['🔒 Security'],
    desc: 'Move-in ready 2-bedroom apartment fully furnished with contemporary furniture. Located in a secure estate with 24/7 CCTV and backup power. Ideal for young professionals and expats.',
    features: ['Fully Furnished','Air Conditioned','Fitted Kitchen','CCTV','POP Ceiling','Wardrobe Fittings'],
    propAmenities: [{i:'⚡',l:'Generator'},{i:'🔒',l:'Security'},{i:'🚗',l:'Parking'},{i:'💧',l:'Water'},{i:'📡',l:'Internet'},{i:'🛋',l:'Furnished'},{i:'❄️',l:'A/C'},{i:'🧺',l:'Laundry'}],
    tiktok: '7612758048372886802',
    wa: 'Hello!%20I%20am%20interested%20in%20the%20Furnished%20Apartment%20in%20Lekki%20Phase%202.',
    agentName: 'Al-Wajud Team', agentInitials: 'AW',
    agentGradient: 'linear-gradient(135deg,#FFB703,#E63946)', agentRating: 5.0,
  },
  {
    ...
    price: '₦25,000,000', period: '',
    location: 'Ajah, Lagos State', locationKey: 'lagos',
    status: 'LAND FOR SALE', statusColor: '#7C3AED', statusKey: 'sale',
    ptype: 'land', budget: 'low',
    beds: 0, baths: 0, sqm: 600,
    img: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=600&h=420&fit=crop',
    imgs: ['https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1469022563428-aa04fef9f5a2?w=900&h=600&fit=crop'],
    gradient: 'linear-gradient(135deg,#7C3AED,#2D7A76)',
    extraChips: ['📄 C of O','🏗 Buildable'],
    desc: 'Prime 600sqm corner piece land with full Certificate of Occupancy. Dry land with easy road access, suitable for residential or mixed-use development. Located in rapidly developing Ajah corridor.',
    features: ['C of O Title','Corner Piece','Dry Land','Road Access','Perimeter Fenced','Survey Plan'],
    propAmenities: [{i:'📄',l:'C of O'},{i:'📐',l:'600 sqm'},{i:'🏗',l:'Buildable'},{i:'🛣',l:'Road Access'},{i:'📍',l:'Corner Piece'},{i:'✅',l:'Verified'},{i:'🌳',l:'Green Area'},{i:'🏙',l:'Developing'}],
    tiktok: '7612758048372886802',
    wa: 'Hello!%20I%20am%20interested%20in%20the%20Corner%20Piece%20Land%20in%20Ajah%20Lagos.',
    agentName: 'Al-Wajud Team', agentInitials: 'AW',
    agentGradient: 'linear-gradient(135deg,#FFB703,#E63946)', agentRating: 5.0,
  },
  {
    ...
    price: '₦60,000,000', period: '/yr',
    location: 'GRA Phase 2, Port Harcourt', locationKey: 'port harcourt',
    status: 'FOR RENT', statusColor: '#E63946', statusKey: 'rent',
    ptype: 'duplex', budget: 'mid',
    beds: 3, baths: 3, sqm: 190,
    img: 'https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=600&h=420&fit=crop',
    imgs: ['https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1512917774080-9991f1c4c750?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1554995207-c18c203602cb?w=900&h=600&fit=crop'],
    gradient: 'linear-gradient(135deg,#E63946,#FBC598)',
    extraChips: ['🔒 24/7'],
    desc: 'Well-finished 3-bedroom terrace in the serene GRA Phase 2, Port Harcourt. Contemporary design with open-plan living and a private rear garden. Gated community with 24/7 security.',
    features: ['Rear Garden','Open Plan Living','Fitted Kitchen','CCTV','Tiled Throughout','Parking Space'],
    propAmenities: [{i:'🔒',l:'Security'},{i:'🚗',l:'Parking'},{i:'⚡',l:'Generator'},{i:'💧',l:'Water'},{i:'🌿',l:'Garden'},{i:'📡',l:'Internet'},{i:'🏠',l:'Gated Estate'},{i:'🧹',l:'Facilities'}],
    tiktok: '7612758048372886802',
    wa: 'Hello!%20I%20am%20interested%20in%20the%20Terrace%20House%20in%20Port%20Harcourt.',
    agentName: 'Al-Wajud Team', agentInitials: 'AW',
    agentGradient: 'linear-gradient(135deg,#FFB703,#E63946)', agentRating: 5.0,
  },
  {
    id: 8,
    title: 'Off-Plan 4-Bedroom Duplex',
    price: '₦95,000,000', period: '',
    location: 'Ibeju-Lekki, Lagos State', locationKey: 'lagos',
    status: 'OFF-PLAN', statusColor: '#FFB703', statusKey: 'offplan',
    ptype: 'duplex', budget: 'mid',
    beds: 4, baths: 3, sqm: 280,
    img: 'https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=600&h=420&fit=crop',
    imgs: ['https://images.unsplash.com/photo-1487958449943-2429e8be8625?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1580587771525-78b9dba3b914?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=900&h=600&fit=crop'],
    gradient: 'linear-gradient(135deg,#FFB703,#0F5E36)',
    extraChips: ['📅 Q3 2026'],
    desc: 'Invest early in this off-plan 4-bedroom luxury duplex in the fast-growing Ibeju-Lekki corridor. Modern architecture, flexible payment plan available. Estimated completion Q3 2026.',
    features: ['Payment Plan','High ROI Area','Modern Design','Smart Home Prep','Solar Ready','Gated Estate'],
    propAmenities: [{i:'🏊',l:'Pool'},{i:'🏋️',l:'Gym'},{i:'🔒',l:'Security'},{i:'🚗',l:'Parking'},{i:'⚡',l:'Solar Ready'},{i:'💧',l:'Borehole'},{i:'🌿',l:'Green Belt'},{i:'🏪',l:'Mall Nearby'}],
    tiktok: '7612758048372886802',
    wa: 'Hello!%20I%20am%20interested%20in%20the%20Off-Plan%20Duplex%20in%20Ibeju-Lekki.',
    agentName: 'Al-Wajud Team', agentInitials: 'AW',
    agentGradient: 'linear-gradient(135deg,#FFB703,#E63946)', agentRating: 5.0,
  },
  {
    ...
    price: '₦800,000', period: '/month',
    location: 'Victoria Island, Lagos', locationKey: 'lagos',
    status: 'SHORT LET', statusColor: '#2D7A76', statusKey: 'shortlet',
    ptype: 'apartment', budget: 'low',
    beds: 2, baths: 2, sqm: 110,
    img: 'https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=600&h=420&fit=crop',
    imgs: ['https://images.unsplash.com/photo-1493809842364-78817add7ffb?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=900&h=600&fit=crop','https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=900&h=600&fit=crop'],
    gradient: 'linear-gradient(135deg,#2D7A76,#FBC598)',
    extraChips: ['🛎 Serviced'],
    desc: 'Luxuriously serviced 2-bedroom apartment perfect for corporate travelers and short stays. Housekeeping included, fully equipped kitchen, and high-speed Wi-Fi. Available daily, weekly or monthly.',
    features: ['Housekeeping','Fast Wi-Fi','Netflix Ready','Fully Furnished','Daily/Weekly/Monthly','Concierge'],
    propAmenities: [{i:'🛎',l:'Concierge'},{i:'🔒',l:'Security'},{i:'🚗',l:'Parking'},{i:'⚡',l:'Generator'},{i:'💧',l:'Water'},{i:'📡',l:'Fibre'},{i:'❄️',l:'A/C'},{i:'🧺',l:'Laundry'}],
    tiktok: '7612758048372886802',
    wa: 'Hello!%20I%20am%20interested%20in%20the%20Short%20Let%20Apartment%20in%20Victoria%20Island.',
    agentName: 'Al-Wajud Team', agentInitials: 'AW',
    agentGradient: 'linear-gradient(135deg,#FFB703,#E63946)', agentRating: 5.0,
  },
];

export const ALL_PROPERTIES = FEATURED_PROPERTIES;
